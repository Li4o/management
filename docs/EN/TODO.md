...
- [ ] Build Class APIs (`/api/v1/class`)
  ...
  - [x] `POST /classes` (Create a new class)
...
- [x] Build Custom Fields APIs (`/api/v1/classes/:classId/custom-fields`)
  - [x] `GET /classes/:classId/custom-fields` (Get custom-fields)
  - [x] `POST /classes/:classId/custom-fields` (Add new custom-fields)
  - [x] `DELETE /classes/:classId/custom-fields/:id` (Delete equipment)
